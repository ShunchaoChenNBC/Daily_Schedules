...
where adobe_date =  current_date("America/New_York")-1 and adobe_tracking_id is not null and lower(consumption_type_detail) = "vod"),
...
where report_date = current_date("America/New_York")-1 and entitlement = "Premium"
